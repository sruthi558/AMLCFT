...
*/
  ...
  function itCount(count, countSubmited) {
    if (count == undefined) {
      options.series[0] = 0;
      options8.series[0] = 0;
    } else {
  ...
  function mlroCount(count, coutAcceptedSTR, coutAcceptedNONSTR10) {
    if (count == undefined) {
      options.series[0] = 0;
      options5.series[0] = 0;
      options5.series[1] = 0;
      ...
      options5.series[1] = coutAcceptedNONSTR10;
    }
  }

  function cmCount(count, coutAcceptedSTR, coutAcceptedNONSTR10) {
    if (count == undefined) {
      options.series[0] = 0;
      options6.series[0] = 0;
      options6.series[1] = 0;
  ...
  function agmCount(count, coutAcceptedSTR, coutAcceptedNONSTR10) {
    if (count == undefined) {
      options.series[0] = 0;
      options7.series[0] = 0;
      options7.series[1] = 0;
      ...
      options.series[0] = count;
      options7.series[0] = coutAcceptedSTR;
